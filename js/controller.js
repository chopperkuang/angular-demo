function CustomerListCtrl($scope) {
    $scope.customers = [
        ...
        {id:'83456', name:'廖青',   status:'求购', area:'国际利都城', size:'2室2厅2卫', type:'B类', tel:'65989743'},
        ...
        {id:'42424', name:'方小姐', status:'求租', area:'同济大学', size:'2室2厅2卫', type:'B类', tel:'13657890987'},
        ...
        {id:'43434', name:'赵阳',   status:'求购', area:'静安－国际丽都城', size:'2室2厅2卫', type:'C类', tel:'13657890987'},
        {id:'34433', name:'匡前阳', status:'求购', area:'静安－曹家渡', size:'2室2厅2卫', type:'C类', tel:'13657890987'}
    ];
